...
if __name__ == '__main__':
  ...
  if not os.path.exists("ComputeIR.h"):
    os.makedirs("include/operator")
  gen_compute_ir(operator_schemas, 'OperatorTemplate.h', 'include/operator/${OperatorName}.h')
  if not os.path.exists("ComputeIR.cpp"):
    os.makedirs("lib/operator")
  gen_compute_ir(operator_schemas, 'OperatorTemplate.cpp', 'lib/operator/${OperatorName}.cpp')
